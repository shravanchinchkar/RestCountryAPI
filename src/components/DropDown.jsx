    ...
    <div
      className={
        value.themeToggle === "off"
          ? "absolute new-sm-3:w-[220px] new-sm:w-[200px] z-10 new-sm-3:top-[160px] new-sm-3:left-[14px] new-sm-2:top-[180px] new-sm-2:left-[17px] new-sm:top-[80px] new-sm:right-[32px] new-sm:left-auto new-lg:top-[90px] new-lg:right-[48px] new-xl:top-[110px] new-xl:right-[80px] rounded-[5px] bg-white px-[1rem] py-[1rem] shadow-new-boxshawod"
// bg-[#2b3945]
          : "absolute new-sm-3:w-[220px] new-sm:w-[200px] z-10 new-sm-3:top-[150px] new-sm-3:left-[14px] new-sm-2:top-[180px] new-sm-2:left-[17px] new-sm:top-[80px] new-sm:right-[32px] new-sm:left-auto new-lg:top-[90px] new-lg:right-[48px] new-xl:top-[110px] new-xl:right-[80px] rounded-[5px] bg-[#2b3945] text-white px-[1rem] py-[1rem] shadow-new-boxshawod"
      }
